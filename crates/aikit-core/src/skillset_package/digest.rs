...
//!
//! Package receipts and provider ecosystems speak sha256, and `aikit-core`
//! stays free of I/O and of extra crates, so the digest lives here. It is the
//! FIPS 180-4 algorithm verbatim; the tests pin it to the standard vectors.
...
mod tests {
    ...
    fn streaming_matches_one_shot() {
        ...
        assert_eq!(hasher.finish_hex(), sha256_hex(&data));
    }
}
