//! Provider-owned semantic enrichment for the general O:I operative field.
//!
...
pub trait OperativeSemanticProvider {
    ...
    fn enrich_action(&self, profile: &ActionSemanticProfile)
...
mod tests {
    ...
    fn provider_can_bind_full_profile_types_without_replacing_general_identity() {
        ...
        assert_eq!(
            provider.bind_horizon(AddressHorizon::H5).unwrap(),
            Some("R#".into())
        );
        assert_eq!(
