...
//!
//! Semantic resource/Project identity remains authoritative. A repository,
//! worktree, branch or commit is a material/history relation, never a replacement
//! identity for the World that is being inspected or changed.
...
pub trait VersionedWorldProvider {
    ...
    fn reconcile(&self, project: &ProjectRef, locator: &str) -> Result<VersionedProjectWorld> {
